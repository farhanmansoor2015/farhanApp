...
class DegreesControllerTest < ActionController::TestCase
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post :create, degree: { End: @degree.End, Name: @degree.Name, Start: @degree.Start, department_id: @degree.department_id }
    end
  ...
  test "should update degree" do
    patch :update, id: @degree, degree: { End: @degree.End, Name: @degree.Name, Start: @degree.Start, department_id: @degree.department_id }
    assert_redirected_to degree_path(assigns(:degree))
  end
