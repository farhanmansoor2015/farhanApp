class FacultiesController < ApplicationController
  ...
  private
    ...
    def faculty_params
      params.require(:faculty).permit(:Firstname, :Lastname, :Designation, :Nic, :Address, :City, :Province, :District, :Contact,:Email, :department_id, :degree_id, :subject_id, :Employee_id)
    end
end
